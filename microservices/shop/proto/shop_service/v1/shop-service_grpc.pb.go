...
const (
	...
	ShopService_ListShops_FullMethodName            = "/shop_service.v1.ShopService/ListShops"
	ShopService_GetShopsByOwner_FullMethodName      = "/shop_service.v1.ShopService/GetShopsByOwner"
...
type ShopServiceClient interface {
	...
	GetShopsByOwner(ctx context.Context, in *GetShopsByOwnerRequest, opts ...grpc.CallOption) (*ListShopsResponse, error)
...
func (c *shopServiceClient) GetShopsByOwner(ctx context.Context, in *GetShopsByOwnerRequest, opts ...grpc.CallOption) (*ListShopsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListShopsResponse)
...
type ShopServiceServer interface {
	...
	GetShopsByOwner(context.Context, *GetShopsByOwnerRequest) (*ListShopsResponse, error)
...
func (UnimplementedShopServiceServer) GetShopsByOwner(context.Context, *GetShopsByOwnerRequest) (*ListShopsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShopsByOwner not implemented")
}
...
var ShopService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/shop_service/v1/shop-service.proto",
}
